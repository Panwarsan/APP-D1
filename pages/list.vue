<template>
  ...
  export default {
   ...
   async created () {
    ...
    //   async save () {
    //     console.log('save data',this.students[this.editedIndex])
    //     // if (this.editedIndex > -1) {
    //     //   Object.assign(this.students[this.editedIndex], this.editedItem)
    //     // } else {
    //       this.students.push(this.editedItem)
    //       const response = await axios.post('http://localhost:7000/update',this.students[this.editedIndex]);
    //         this.students = response.data;
    //         console.log("students =", this.stds);
    //     // }
    //     // this.close()
    //   },
    async save () {
        ...
        // // } else {
        // //    this.students.push(this.editedItem)
        //   const response = await axios.post('http://localhost:7000/update',this.std)
